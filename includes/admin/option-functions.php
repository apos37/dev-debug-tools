...
<div class="full_width_container">
    <table class="admin-large-table functions-table">
        <tr>
        ...
        <tr>
            ...
            <td><strong><?php echo wp_kses_post( ddtt_highlight_string( 'dpr( $array, 3 );' ) ); ?></strong>
        ...
        <tr>
            ...
            <td><strong><?php echo wp_kses_post( ddtt_highlight_string( 'ddtt_var_dump_to_string( $var );' ) ); ?></strong></td>
        </tr>
        <tr>
            <td>Add JavaScript alert in PHP</td>
            <td><strong><?php echo wp_kses_post( ddtt_get_function_example( "ddtt_alert" ) ); ?></strong></td>
            <td><strong><?php echo wp_kses_post( ddtt_highlight_string( 'ddtt_alert( "Test 1" );' ) ); ?></strong>
        ...
        <tr>
            ...
            <td><strong><?php echo wp_kses_post( ddtt_highlight_string( 'ddtt_console( "Test 1" );' ) ); ?></strong></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><strong><?php echo wp_kses_post( ddtt_highlight_string( 'ddtt_backtrace();' ) ); ?></strong>
        ...
        <tr>
            ...
            <td><strong><?php echo wp_kses_post( ddtt_highlight_string( 'ddtt_debug_form_post( "'.sanitize_email( get_userdata( get_current_user_id() )->user_email ).'", 1 );' ) ); ?></strong>
        ...
        <tr>
            ...
            <td><strong><?php echo wp_kses_post( ddtt_highlight_string( 'ddtt_increase_test_number();' ) ); ?></strong>
        ...
        <tr>
            ...
            <td><strong><?php echo wp_kses_post( ddtt_highlight_string( 'if ( ddtt_is_site( "'.esc_html( ddtt_get_domain( false, true ) ).'" ) ) { ... }' ) ); ?></strong>
