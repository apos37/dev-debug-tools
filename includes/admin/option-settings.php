    ...
    <form method="post" action="options.php">
        ...
        <div id="testing-options"<?php echo wp_kses( $readonly, $allowed_html ); ?>>
            ...
            <table class="form-table">
                ...
                <?php echo wp_kses( ddtt_options_tr( 'max_log_size', 'Maximum Debug Log Size for Viewer', 'number', '<br>The maximum file size in MB allotted for viewing the debug log before giving a warning. This is set to prevent the page from crashing if it is too big and not allowing you to clear it.', [ 'width' => '10rem', 'default' => 3 ] ), $allowed_html ); ?>
