...
class DDTT_MENU {
    ...
    public function admin_menu() {
        ...
        // $icon = DDTT_PLUGIN_IMG_PATH.'icon-15x15.png';
        ...
        add_menu_page(
            ...
            DDTT_NAME,          // Text to show on the menu link
...
function ddtt_plugin_menu_items( $slug = null, $desc = false ) {
    ...
    $items = [
        ...
        'plugins'       => [ __( 'Active Plugins', 'dev-debug-tools' ), 'We have replaced the default featured plugins with <a href="/'.DDTT_ADMIN_URL.'/plugin-install.php?tab=featured">our own plugin recommendations here</a>.' ],
