 ...
 * Description:         Sets the error reporting level for debugging. Added via Developer Debug Tools plugin under Error Reporting tab.
 * Version:             1.0.0
 * Author:              Apos37
...
// Is enabled?
$enabled = get_option( 'ddtt_error_enable' );
if ( !$enabled ) {
	return;
}

// Check for settings made from Developer Debug Tools
$constants = get_option( 'ddtt_error_constants' );
if ( !$constants ) {
	return;
} else {
